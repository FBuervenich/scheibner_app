...
// Form_Activate
    double cmd_winkelbogen = cmdWinkel *
        pi /
...
// Kette berechnen
    ...
    lkwGrad = lkwGrad;
    nachlauf = nachlaufFb;
    nachlaufReal = nachlaufReal;
    offset = offset;
    schwingenwinkelGrad = schwingenwinkelGrad;
    gabellaenge = gabellaengeFb;
    schwingenlaenge = schwingenlaengeFb;
    heckhoehe = heckhoehe;
    radstand = radstandFb;
